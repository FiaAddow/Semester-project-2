          ...
          <div className="relative flex flex-col min-w-0 bg-white w-full mb-6 shadow-xl rounded-lg mt-16">
            <div className="px-6">
                ...
                <div className="w-full px-4 flex justify-center">
                  <div className="relative">
                    <img
                      ...
                      className="shadow-xl rounded-full h-auto align-middle mx-auto border-0 -m-16 max-w-10-px"
                    />
                  </div>
                </div>
              ...
              <div className="mt-10 py-10 border-t text-center">
                <h1 className="text-2xl font-fairy mb-4 text-fairy-3">
                  My listings
                </h1>
                <div>
                    ...
                    <div className="gap-10 mb-4 ">
                      {profile.listings.map((listing) => (
                        <Link to={`/listings/${listing.id}`} key={listing.id}>
                          <div
                            key={listing.id}
                            className="bg-fairy-1 border border-fairy-5 rounded overflow-hidden flex flex-col pt"
                          >
                            <div
                              key={listing.id}
                              className="overflow-hidden rounded-lg p-5 text-xl"
                            >
                              Listing: {listing?.title} - Ends at{" "}
